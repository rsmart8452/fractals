...
public class BurningShipPixel : IPixelCalculator
{
  ...
  public string Type => FractalType.BurningShip;
  ...
  private static int Compute(double real, double imaginary, int maxIterations)
  {
    ...
    var currentImaginary = 2d * Math.Abs(imaginary) * Math.Abs(real) + imaginary;
